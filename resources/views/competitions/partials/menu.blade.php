	...
	<div class="scrolling-wrapper">
		<ul>
			...
			<li class="item {{ \Route::current()->getName() == 'competitions.calendar' ? 'active' : '' }}">
				<a href="{{ route('competitions.calendar', [active_season()->slug, $group->phase->competition->slug]) }}">
			...
			@if ($league->has_stats())
				<li class="item {{ \Route::current()->getName() == 'competitions.stats' ? 'active' : '' }}">
					<a href="{{ route('competitions.stats', [active_season()->slug, $group->phase->competition->slug]) }}">
