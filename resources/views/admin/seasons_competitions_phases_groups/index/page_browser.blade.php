<div class="pagebrowser px-3 px-md-0 py-2">
    ...
    <div class="d-table">
        <img src="{{ $phase->competition->getImgFormatted() }}" alt="" width="38" class="d-table-cell align-middle">
        <h5 class="text-uppercase m-0 d-table-cell align-middle pl-2">
            <span class="d-none d-sm-inline-block">{{ $phase->name }}</span>
            <i class="d-none d-sm-inline-block fas fa-angle-double-right text-warning"></i>
            <span class="">Grupos</span>
            <span class="d-block d-sm-none" style="font-size: 0.5em">{{ $phase->name }}</span>
        </h5>
    </div>
</div>