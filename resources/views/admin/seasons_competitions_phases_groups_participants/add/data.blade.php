...
@else
    <div class="text-center border-top py-4">
        <i class="fas fa-ban d-block text-center mb-3 text-warning" style="font-size: 4em"></i>
        Se ha alcanzado el límite de participantes del grupo
        <a href="{{ route('admin.season_competitions_phases_groups_participants', [$group->phase->competition->slug, $group->phase->slug, $group->slug]) }}" class="d-block mt-2">Volver al listado</a>
    </div>
@endif
