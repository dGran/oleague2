<div class="tableOptions animated fadeIn">
    <a href="{{ route('admin.games.add') }}" class="btn btn-primary" id="btnAdd">
            ...
            <a href="" onclick="import_file()">
               <form
                id="frmImport"
                    ...
                    role="form"
                    method="POST"
                    action="{{ route('admin.games.import.file') }}"
...
<form class="frmFilter" role="search" method="get" action="{{ route('admin.games') }}">
