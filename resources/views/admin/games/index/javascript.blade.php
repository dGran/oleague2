<script>
    ...
    $(".btn-delete").click(function(e) {
        ...
        swal({
            title: "¿Estás seguro?",
            text: 'Se va a eliminar el juego "' + name + '". No se podrán deshacer los cambios!',
            buttons: {
                confirm: {
        ...
        .then((value) => {
            if (value) {
                ...
                var url = form.attr('action').replace(':GAME_ID', id);
    ...
    function destroyMany() {
        ...
        swal({
            title: "¿Estás seguro?",
            text: 'Se van a eliminar los juegos seleccionados. No se podrán deshacer los cambios!',
            buttons: {
                confirm: {
                    text: "Sí, estoy seguro",
                    value: true,
        ...
        .then((value) => {
            if (value) {
                ...
                var url = '{{ route("admin.games.destroy.many", ":ids") }}';
    ...
    function duplicateMany() {
        ...
        var url = '{{ route("admin.games.duplicate.many", ":ids") }}';
        url = url.replace(':ids', ids);
        window.location.href=url;
    }
        ...
        .then((value) => {
            if (value) {
                ...
                if (!filename ) {
                    ...
                    var filename = 'juegos_export' + time;
                }
                $(location).attr('href', 'juegos/exportar/' + filename + '/' + type + '/' + filterName + '/' + order);
            }
        });
    }
    ...
    function export_file_selected(type) {
        ...
        .then((value) => {
            if (value) {
                ...
                $(location).attr('href', 'juegos/exportar/' + filename + '/' + type + '/' + filterName + '/' + order + '/' + ids);
            }
        });
    }
