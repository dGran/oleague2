<form
    ...
    role="form"
    method="POST"
    action="{{ route('admin.table_zones.update', $table_zone->id) }}"
    ...
    <div class="table-form-content col-12 col-lg-8 col-xl-6 p-md-3 animated fadeIn">
        <div class="form-group row pt-2">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="name" name="name" placeholder="Nombre" value="{{ old('name', $table_zone->name) }}" autofocus>
            ...
            <div class="col-sm-9">
                <div class="input-group mb-1">
                    <div class="input-group-prepend">
                        <button class="btn btn-danger {{ $table_zone->img ? 'd-inline-block' : 'd-none' }}" type="button" id="img_remove">Eliminar</button>
                        {{-- <span class="input-group-text">Eliminar</span> --}}
                    </div>
                     <div class="custom-file">
                        <input type="hidden" name="old_img" id="old_img" value="{{ $table_zone->img }}">
                ...
                <div class="preview mt-2 border p-3 {{ $table_zone->img ? 'd-block' : 'd-none' }}">
                    <figure class="m-0">
                        <img id="img_preview" src="{{ $table_zone->getImgFormatted() }}" alt="img" width="96">
                    </figure>
                </div>
            </div>
        </div>
