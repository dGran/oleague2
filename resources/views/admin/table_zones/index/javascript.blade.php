<script>
    ...
    function cancelFilters() {
        window.location.href = '{{ route("admin.table_zones") }}';
    }
    ...
    $(".btn-delete").click(function(e) {
        ...
        swal({
            title: "¿Estás seguro?",
            text: 'Se va a eliminar el marcado de zonas "' + name + '". No se podrán deshacer los cambios!',
            buttons: {
                confirm: {
        ...
        .then((value) => {
            if (value) {
                ...
                var url = form.attr('action').replace(':ZONE_ID', id);
    ...
    function destroyMany() {
        ...
        swal({
            title: "¿Estás seguro?",
            text: 'Se van a eliminar los marcado de zonas seleccionados. No se podrán deshacer los cambios!',
            buttons: {
                confirm: {
                    text: "Sí, estoy seguro",
                    value: true,
        ...
        .then((value) => {
            if (value) {
                ...
                var url = '{{ route("admin.table_zones.destroy.many", ":ids") }}';
    ...
    function duplicateMany() {
        ...
        var url = '{{ route("admin.table_zones.duplicate.many", ":ids") }}';
        url = url.replace(':ids', ids);
        window.location.href=url;
    }
        ...
        .then((value) => {
            if (value) {
                ...
                if (!filename ) {
                    ...
                    var filename = 'marcado_de_zonas_export' + time;
                }
                $(location).attr('href', 'marcado_de_zonas/exportar/' + filename + '/' + type + '/' + filterName + '/' + order);
            }
        });
    }
    ...
    function export_file_selected(type) {
        ...
        .then((value) => {
            if (value) {
                ...
                $(location).attr('href', 'marcado_de_zonas/exportar/' + filename + '/' + type + '/' + filterName + '/' + order + '/' + ids);
            }
        });
    }
