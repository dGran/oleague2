<form
    ...
    role="form"
    method="POST"
    action="{{ route('admin.players_dbs.update', $database->id) }}"
    ...
    <div class="table-form-content col-12 col-lg-8 col-xl-6 p-md-3 animated fadeIn">
        <div class="form-group row pt-2">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name" name="name" placeholder="Nombre" value="{{ old('name', $database->name) }}" autofocus>
